...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-rich-text-editor-api?sort=semver)](https://github.com/liberusoftware/module-cms-rich-text-editor-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-rich-text-editor-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-rich-text-editor-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-rich-text-editor-api
```
...
<a href="https://github.com/liberusoftware/module-cms-rich-text-editor-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-rich-text-editor-api" alt="Contributors to liberusoftware/module-cms-rich-text-editor-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-rich-text-editor-api/graphs/contributors).
